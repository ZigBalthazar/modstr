...
export const analyzeResultSchema = z.object({
	status: z.nativeEnum(ClassificationStatus).describe("Status of the analysis"),
	labels: z.array(z.nativeEnum(ClassificationLabel)).describe("Array of labels assigned to the event"),
	reason: z.string().describe("Reason for the assigned status"),
});
